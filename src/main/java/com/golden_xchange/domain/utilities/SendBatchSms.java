...
public class SendBatchSms {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        for(int var6 = 0; var6 < var5; ++var6) {
            ...
            send.send("sendSms.sh", phone.replace(" ", "").trim(), "You are kindly reminded of a New community!!! www.goldenriches.co.za. No central account, 30% interest paid within a minimum of 3 days. Please visit the above website. The first list will be uploaded on the 16th of February 2017 at 06:00am. Minimum to assist is R300 maximum is R6500. Dont be left out.");
        }
