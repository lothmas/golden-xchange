...
public class SendEmailMessages {
    public void sendMessage(String toEmail, String newPassword,String messageToSend) {
        ...
        Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                if(null==messageToSend) {
                    ...
                    return new PasswordAuthentication("mindset.24.7.notifications@gmail.com", "L0thmas1@");
                }
            }
        });
        ...
        try {
            ...
            if(null==messageToSend) {
                ...
                message.setSubject("MindSet Donation Notification");
                message.setContent(messageToSend+ "<p></>" + htmlText, "text/html; charset=utf-8");
            }
