 ...
 *         &lt;element name="returnData" type="{getMainList.webservice.goldenriches.com}MainList" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetMainListResponse")
public class GetMainListResponse {
    ...
    @XmlElement(required = true)
    protected List<MainList> returnData;
     ...
     * 
     */
    public List<MainList> getReturnData() {
        if (returnData == null) {
            returnData = new ArrayList<MainList>();
        }
